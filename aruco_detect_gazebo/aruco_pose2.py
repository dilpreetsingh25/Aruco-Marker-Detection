...
class ArucoDetector(Node):
    def __init__(self):
        ...
        # turtlebot3 it is /camera/image_raw and my_robot_bringup /camera_sensor/image_raw
        ...
        # Direct paths to your calibration files
    ...
    def listener_callback(self, msg):
        ...
        if ids is not None:
            ...
            for i in range(len(ids)):
                ...
                self.publishers_ = self.create_publisher(Float32, "topic_news", 10)
                self.timer_ = self.create_timer(0.1, self.publish_news)
                self.get_logger().info("Aruco Topic started")
